...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // 0: Base Layer
  [_BL] = LAYOUT_60_ansi(
    F(0),                  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,    KC_0,    KC_MINS,  KC_EQL,                          F(3),    \
  ...
  [_FL] = LAYOUT_60_ansi(
    ...
    KC_TRNS,          KC_APP,  KC_TRNS, KC_END,  LSFT(KC_INS), KC_TRNS, KC_END,  KC_HOME, KC_PGUP, KC_PGDN, KC_END,             KC_PGUP,          \
  ...
  // 3: Mouse & RGB Layer
  [_ML] = LAYOUT_60_ansi(
    KC_TRNS, BL_TOGG, BL_STEP, RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI, RGB_HUD, RGB_SAD, RGB_VAD, KC_TRNS, KC_TRNS,          KC_TRNS, \
    ...
    KC_TRNS,          KC_TRNS, KC_BTN3, KC_WH_D, KC_TRNS, KC_TRNS, KC_WH_D, KC_BTN3, KC_TRNS, KC_TRNS, KC_TRNS,          KC_TRNS,          \
