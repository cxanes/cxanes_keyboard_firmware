...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_BL] = KEYMAP(
    ...
    MO(_ML),               KC_LCTL, KC_LALT,                          KC_SPC,                          F(1),    KC_RCTL,  KC_NO,                 KC_RALT,  KC_RGUI),
  ...
  [_FL] = KEYMAP(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS,                   KC_TRNS,                                          KC_TRNS, KC_HOME,  KC_TRNS,  KC_PGDN, KC_END),
  ...
  [_AL] = KEYMAP(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS,                            KC_TRNS, KC_LEFT, KC_TRNS, KC_DOWN, KC_RGHT),
