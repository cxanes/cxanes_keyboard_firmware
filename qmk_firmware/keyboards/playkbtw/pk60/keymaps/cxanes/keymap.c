...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  // 0: Base Layer
  [_BL] = LAYOUT_all(
    F(0),                  KC_1,    KC_2,    KC_3,    KC_4,   KC_5,   KC_6,   KC_7,   KC_8,   KC_9,    KC_0,    KC_MINS,  KC_EQL,                KC_NO,     F(3), \
    ...
    MO(_ML),               KC_LCTL, KC_LALT, KC_NO,                           KC_SPC, KC_NO,  F(1),    KC_RCTL, KC_NO,    KC_RALT,               KC_RGUI),
  ...
  [_FL] = LAYOUT_all(
    ...
    KC_TRNS, KC_TRNS, KC_APP,  KC_TRNS, KC_END,  LSFT(KC_INS), KC_TRNS, KC_END,  KC_HOME, KC_PGUP, KC_PGDN, KC_END,   KC_TRNS,  KC_PGUP, KC_TRNS, \
  ...
  [_AL] = LAYOUT_all(
    ...
    KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,                            KC_TRNS, KC_TRNS, KC_TRNS, KC_LEFT, KC_TRNS, KC_DOWN, KC_RGHT),
  ...
  [_ML] = LAYOUT_all(
    ...
    KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_R, KC_WH_U, KC_TRNS, KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R, KC_TRNS, KC_TRNS, KC_TRNS, F(2),             \
    KC_TRNS, KC_TRNS, KC_TRNS, KC_BTN3, KC_WH_D, KC_TRNS, KC_TRNS, KC_WH_D, KC_BTN3, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, \
